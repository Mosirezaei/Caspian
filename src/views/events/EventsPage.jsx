...
const CATEGORY_FA = {
  Concert: 'کنسرت', Theater: 'تئاتر', Cinema: 'سینما',
  'Opera and ballet': 'اپرا و باله', 'Club and pub': 'کلاب و پاب',
  Party: 'پارتی', 'Stand-up': 'استندآپ', Sport: 'ورزش',
  Exhibition: 'نمایشگاه', Other: 'سایر', Comedy: 'کمدی',
};
