...
export default function SakhtareHoqooqi() {
  useSEO({
    ...
    path: '/blog/sakhtare-hoqooqi-sherktat-armenia',
  });
  ...
  return (
    <div className="min-h-screen" dir="rtl">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12 sm:py-20">
        ...
        <RelatedServices currentPath="/blog/sakhtare-hoqooqi-sherktat-armenia" />

        </div>

          <PageSidebar tags={['LLC', 'IE', 'CJSC', 'legal-structure', 'armenia', 'company']} currentPath="/blog/sakhtare-hoqooqi-sherktat-armenia" />
        </div>
      </main>
    </div>
  );
