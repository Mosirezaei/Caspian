...
export default function HazineMaliyatBank() {
  useSEO({
    ...
    path: '/blog/hazine-maliyat-bank-armenia',
  });
  ...
  return (
    <div className="min-h-screen" dir="rtl">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12 sm:py-20">
        ...
        <RelatedServices currentPath="/blog/hazine-maliyat-bank-armenia" />

        </div>

          <PageSidebar tags={['cost', 'tax', 'bank', 'armenia', 'company', 'finance']} currentPath="/blog/hazine-maliyat-bank-armenia" />
        </div>
      </main>
    </div>
  );
