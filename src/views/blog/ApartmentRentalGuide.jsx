      ...
      <main className="max-w-6xl mx-auto px-4 py-12 sm:py-20">
        ...
        <section className="glass-panel rounded-2xl p-6 mb-6">
          ...
          <div className="text-sm text-foreground/70 leading-7 space-y-3">
            <p>انتخاب مدت اقامت و محله پیش از جست‌وجوی آپارتمان، هزینه نهایی شما رو تا حد زیادی تعیین می‌کنه. در ایروان، مرکز شهر دسترسی و امکانات بیشتری داره، در حالی که عربکیر، کومیتاس و محله‌های دورتر گزینه‌های متعادل‌تری برای بودجه‌های محدود فراهم می‌کنن.</p>
