    ...
    <ServicePageLayout
      ...
      {isFa && <>
        ...
        <InfoBlock title="پوشش کامل انواع خدمات تبدیل ارز">
          ...
          <p className="mb-3">بزرگ‌ترین چالش مسافران ایرانی، خرید درام پیش از سفر یا تبدیل مانده ریال به واحد پول ارمنستان است. با کارت بانکی ایران (از طریق انتقال شتابی، ساتنا یا پایا) می‌توانید معادل نقدی درام یا دلار آمریکا را در دفتر ایروان دریافت کنید — بدون اتلاف وقت و با بهترین نرخ روز.</p>
