...
const PLACES = {
  fa: [
    {
      ...
      name: 'روواق — میدان جمهوری و کاسکاد',
      desc: 'قلب پایتخت ارمنستان. میدان جمهوری با نمای توفی صورتی و آب‌نماهای موزیکال شبانه و کاسکاد پله‌های عز با باغ‌های مجسمه شبیه و گاردری هنری که از بالای آن کل شهر و کوه آرارات دیده می‌شود.',
      distance: 'مرکز شهر',
      time: 'همه‌ی سال، آب‌نماهای موزیکال از اردیبهشت تا مهر',
    },
    {
      img: '/images/armenia/garni-temple.webp',
      name: 'معبد گارنی',
      desc: 'تنها معبد یونانی-رومی پیش از مسیحی در ارمنستان، روی صخره‌ای مشرف به دره‌ای قفقاز. نمونه‌ای نادر از معماری کلاسیک در قفقاز.',
    ...
    },
    {
      ...
      name: 'دریاچه سوان',
      desc: 'یکی از بزرگ‌ترین دریاچه‌های آب‌شیرین جهان در ارتفاع ۱۹۰۰ متری. صومعه سواناوانک، ماهی ایشخان تازه، و هوای خنک تابستانی.',
    ...
    },
    {
      ...
      name: 'تاتف و تله‌کابین باله‌های تاتف',
      desc: 'صومعه‌ای قرن نهم روی صخره‌ای مرتفع، قابل دسترسی با طولانی‌ترین تله‌کابین برگشتی جهان (بیش از ۵ کیلومتر) با منظره‌ی خیره‌کننده دره‌ی وروتان‌زور.',
  ...
  ru: [
    { img: '/images/armenia/yerevan-republic-square.webp', name: 'Ереван — Площадь Республики и Каскад', desc: 'Сердце армянской столицы. Площадь Республики с розовыми туфовыми зданиями и вечерним шоу музыкальных фонтанов, и Каскад — гигантская каменная лестница с садами скульптур и видом на город и гору Арарат.', distance: 'Центр города', time: 'Круглый год; музыкальные фонтаны — с мая по сентябрь' },
    ...
    { img: '/images/armenia/dilijan.webp', name: 'Дилижан', desc: 'Лесной городок, известный как «Армянская Швейцария» — старые деревянные дома, тропы и уютные кафе.', distance: '100 км от Еревана', time: 'Лето — для природы, осень — для красовых красоок' },
    { img: '/images/armenia/tatev.webp', name: 'Татев и канатная дорога «Крылья Татева»', desc: 'Монастырь IX века на высокой скале, куда ведёт самая длинная реверсивная канатная дорога в мире (более 5 км).', distance: '280 км от Еревана (область Сюник)', time: 'Весна–осень; канатная дорога обычно работает ср-вс' },
  ],
};
...
const HEAD = {
  fa: {
    ...
    intro: 'اگر برای اولین‌بار به ارمنستان سفر می‌کنید یا دنبال برنامه‌ریزی فشرده‌تری هستید، این راهنما جاهای دیدنی مهم‌ترین جاهای دیدنی ایران را با فاصله، بهترین زمان بازدید و توضیح کوتاهی معرفی می‌کند.',
    listTitle: 'جاهای دیدنی و مهم ارمنستان',
    tipsTitle: 'نکات برای برنامه‌ریزی سفر',
    creditsTitle: 'منبع تصاویر',
    tips: [
      'ایروان، گارنی، گقارد و خور ویراپ را می‌توان در یک تور روزانه پوشش داد.',
      ...
      'بهترین فصل سفر به ارمنستان اردیبهشت تا مهر است، تابستان‌ها گرم و خشک، پاییز خنک و رنگارنگ.',
    ],
  },
  en: {
  ...
  ru: {
    ...
    intro: 'Планируете первую поездку в Армению или хотите составить более чёткий маршрут? Это главные достопримечательности Еревана и страны.',
    listTitle: 'Главные места для посещения в Армении',
    tipsTitle: 'Советы по планированию поездки',
    creditsTitle: 'Источники фотографий',
    tips: [
      'Ереван, Гарни, Гегард и Хор Вирап можно посетить за один день.',
      'Для Севана и Дилижана запланируйте минимум одну ночёвку.',
      'Татеву нужен отдельный выезд (минимум 2 дня), так как он далеко от Еревана.',
...
const PHOTO_CREDITS = [
  {
    file: 'yerevan-republic-square.webp',
    nameFa: 'میدان جمهوری ایروان', nameEn: 'Republic Square, Yerevan', nameRu: 'Площадь Республики, Ереван',
    author: 'Vyacheslav Argenberg', license: 'CC BY 4.0', licenseUrl: 'https://creativecommons.org/licenses/by/4.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Yerevan,_Republic_Square_of_Yerevan,_Armenia.jpg',
  },
  {
    file: 'yerevan-cascade.webp',
    nameFa: 'کاسکاد ایروان', nameEn: 'Yerevan Cascade', nameRu: 'Каскад Еревана',
    author: 'Wikimedia Commons user "07"', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Yerevan_Cascade_from_below.jpg',
  },
  {
    file: 'garni-temple.webp',
    nameFa: 'معبد گارنی', nameEn: 'Garni Temple', nameRu: 'Храм Гарни',
    author: 'Armenak Margarian', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Garni_Temple_18-11-2010_v2.jpg',
  },
  {
    file: 'geghard-monastery.webp',
    nameFa: 'صومعه گقارد', nameEn: 'Geghard Monastery', nameRu: 'Монастырь Гегард',
    author: 'Vyacheslav Argenberg', license: 'CC BY 4.0', licenseUrl: 'https://creativecommons.org/licenses/by/4.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Geghard_Monastery,_Armenia.jpg',
  },
  {
    file: 'khor-virap.webp',
    nameFa: 'خور ویراپ', nameEn: 'Khor Virap', nameRu: 'Хор Вирап',
    author: 'Andrew Behesnilian (MrAndrew47)', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Khor_Virap_Monastery_and_Mount_Ararat,_Armenia.jpg',
  },
  {
    file: 'lake-sevan.webp',
    nameFa: 'دریاچه سوان', nameEn: 'Lake Sevan', nameRu: 'Озеро Севан',
    author: 'Dor Shabashewitz', license: 'CC BY 4.0', licenseUrl: 'https://creativecommons.org/licenses/by/4.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Lake_Sevan_view_from_Sevanavank.jpg',
  },
  {
    file: 'dilijan.webp',
    nameFa: 'دیلیجان', nameEn: 'Dilijan', nameRu: 'Дилижан',
    author: 'Textfabrikant', license: 'CC0', licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Dilijan_town_lake,_April_2026,_no._6.jpg',
  },
  {
    file: 'tatev.webp',
    nameFa: 'تاتف و تله‌کابین باله‌های تاتف', nameEn: 'Tatev & Wings of Tatev', nameRu: 'Татев и «Крылья Татева»',
    author: 'Clay Gilliland (Flickr)', license: 'CC BY-SA 2.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/2.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:The_Wings_Of_Tatev_and_Tatev_Monastery_(23925883178).jpg',
  },
];
...
export default function ArmeniaGuide() {
  ...
  return (
    <ServicePageLayout
      titleFa="ارمنستان کجا برم؟ راهنمای جاهای دیدنی ایروان"
    ...
    >
      ...
      <InfoBlock title={h.creditsTitle}>
        <ul className="space-y-1.5 mt-2 text-xs text-foreground/60">
          {PHOTO_CREDITS.map((c, i) => {
            const name = lang === 'fa' ? c.nameFa : lang === 'ru' ? c.nameRu : c.nameEn;
            return (
              <li key={i}>
                {name} — {c.author},{' '}
                <a href={c.licenseUrl} target="_blank" rel="noopener noreferrer nofollow" className="underline hover:text-primary">
                  {c.license}
                </a>
                {', '}
                <a href={c.sourceUrl} target="_blank" rel="noopener noreferrer nofollow" className="underline hover:text-primary">
                  Wikimedia Commons
                </a>
              </li>
            );
