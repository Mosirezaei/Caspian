  ...
  return (
    <ServicePageLayout titleFa="پذیرش دانشجویی" titleEn="Student Admission" titleRu="Поступление в вузы" serviceType="student-visa"
      ...
      {isFa && <>
        ...
        <InfoBlock title="آیا برای تحصیل در ارمنستان نیاز به مدرک زبان است؟">
          <p className="mb-3">یکی از سؤالات پرتکرار متقاضیان این است که آیا بدون مدرک زبان (مثل آیلتس یا مدرک روسی) امکان تحصیل وجود دارد یا نه. خبر خوب این است که اکثر برنامه‌های انگلیسی‌زبان پزشکی، دندانپزشکی و مهندسی در دانشگاه‌های ارمنستان، پذیرش دانشجویان بین‌المللی را بدون الزام به ارائه مدرک زبان رسمی انجام می‌دهند و در بسیاری موارد یک مصاحبه یا آزمون تعیین سطح داخلی دانشگاه کافی است.</p>
        </InfoBlock>

        <InfoBlock title="بورسیه و تخفیف شهریه دانشگاه‌های ارمنستان">
          <p>برخی از دانشگاه‌های ارمنستان از جمله YSU و SEUA، بر اساس معدل دیپلم یا نتیجه آزمون ورودی داخلی، بورسیه‌های جزئی (تخفیف ۲۰ تا ۵۰ درصدی شهریه) برای دانشجویان ممتاز بین‌المللی در نظر می‌گیرند. این بورسیه‌ها معمولاً رقابتی و محدود هستند و بهتر است در همان ترم اول ثبت‌نام درخواست داده شوند.</p>
        </InfoBlock>
