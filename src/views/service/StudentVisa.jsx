...
function Content() {
  ...
  return (
    <ServicePageLayout titleFa="ویزای تحصیلی ارمنستان و روسیه" titleEn="Armenia & Russia Student Visas" titleRu="Учебные визы в Армению и Россию"
      subtitleFa="ارمنستان و روسیه — مدارک، مراحل و هزینه هر مسیر"
      subtitleEn="Armenia and Russia — documents, steps, costs"
      subtitleRu="Армения и Россия — документы, этапы, стоимость"
      heroImage="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=1200&q=75"
      serviceType="student-visa">

      {isFa && <>
        <InfoBlock title="چرا برای ویزای تحصیلی از ایروان اقدام کنید؟">
          <p>سفارتخانه‌ها در ایروان معمولاً وقت سفارت سریع‌تر و نرخ تأیید بالاتری نسبت به دفاتر داخل ایران دارند. کاسپین گروپ با تجربه در اخذ ویزای تحصیلی ارمنستان و روسیه، از آماده‌سازی مدارک پذیرش دانشگاه تا تحویل ویزا را پیگیری می‌کند.</p>
        </InfoBlock>
        <InfoBlock title="مقایسه ویزای تحصیلی ارمنستان و روسیه">
          ...
          <p>MSU، RUDN، SPbU. ویزای تحصیلی از سفارت ایروان. مدت پردازش ۲ تا ۴ هفته. بورسیه دولتی موجود.</p>
        </InfoBlock>
        <InfoBlock title="مدارک مشترک برای ویزای تحصیلی">
          <CheckList items={[
        ...
        <InfoBlock title="خدمات کاسپین برای ویزای تحصیلی">
          <CheckList items={[
            'مشاوره انتخاب دانشگاه بر اساس رشته و بودجه',
      ...
      {lang === 'en' && <>
        ...
        <InfoBlock title="Armenia vs Russia Student Visas">
          <CheckList items={[
      ...
      {isRu && <>
        ...
        <InfoBlock title="Армения и Россия — сравнение учебных виз">
          <CheckList items={[
