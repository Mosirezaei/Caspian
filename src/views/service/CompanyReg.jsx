  ...
  return (
    <ServicePageLayout
      ...
      {isFa && <>
        ...
        <InfoBlock title="الزام سوشیال نامبر ارمنستان برای ثبت شرکت">
          <p>یکی از نکات مهمی که کمتر کسی از قبل می‌داند این است که برای ثبت رسمی شرکت و به‌خصوص برای افتتاح حساب بانکی شرکتی، هر یک از اعضا و مدیران شرکت باید یک شماره اجتماعی ارمنستان (Social Card / سوشیال نامبر) دریافت کنند. این شماره از طریق اداره ثبت‌احوال ارمنستان صادر می‌شود، معمولاً در همان روز یا روز بعد آماده است و نیازمند حضور فیزیکی شخص در ارمنستان است. کاسپین گروپ هماهنگی و همراهی برای دریافت این شماره را به‌عنوان بخشی از فرآیند ثبت شرکت انجام می‌دهد.</p>
        </InfoBlock>
