...
export const blogPosts = [
  ...
  },
  {
    ...
    date: '2026-09-03',
    fa: {
      title: 'بهترین محله\u200cهای ایروان برای اجاره: کِنترون، آرابگیر، کومیتاس و گزینه\u200cهای اقتصادی',
      excerpt: 'مقایسه محله\u200cهای ایروان برای اجاره خانه — دسترسی، هزینه و کیفیت زندگی در کِنترون، آرابگیر، کومیتاس، داوتاشن و کاسکاد.',
    },
    en: {
  ...
  },
  {
    ...
    fa: {
      ...
      excerpt: 'مقایسه محله\u200cهای کنترون، آرابگیر، کومیتاس و داوتاشن از نظر قیمت، دسترسی و امکانات.',
    },
    en: {
