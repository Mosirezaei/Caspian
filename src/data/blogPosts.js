...
export const blogPosts = [
  ...
  { slug: 'apartment-booking-yerevan-companies', href: '/blog/apartment-booking-yerevan-companies', category: 'life', thumbnail: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=640&q=70', tags: ['armenia', 'guide', 'life'], date: '2026-09-08', fa: { title: 'رزرو آپارتمان در ایروان برای شرکت‌ها و مسافران', excerpt: 'چطور برای اقامت کوتاه‌مدت یا کاری، آپارتمان مناسب در ایروان رزرو کنیم؟' }, en: { title: 'رزرو آپارتمان در ایروان برای شرکت‌ها و مسافران', excerpt: 'چطور برای اقامت کوتاه‌مدت یا کاری، آپارتمان مناسب در ایروان رزرو کنیم؟' } },
