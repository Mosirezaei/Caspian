...
const content = {
  fa: {
    ...
    storyTitle: 'کاسپین',
    story: [
      'کاسپین گروه ارمنستان در سال ۲۰۰۸ با هدف ارائه خدمات حرفه‌ای مهاجرت و سفر به ایرانیان در ایروان تأسیس شد.',
      'با استقرار دفتر مرکزی در قلب ایروان، ما در طول بیش از یک دهه به بسیاری از هموطنان در دریافت ویزا، اقامت، ثبت شرکت و رزرو هتل و  سفر کمک کرده‌ایم.',
...
function AboutContent() {
  ...
  return (
    <div dir={isRtl ? 'rtl' : 'ltr'} className="min-h-screen bg-background font-vazir">
      <Helmet>
        <title>درباره ما | گروه کاسپین ارمنستان</title>
        <meta name="description" content="بیش از ۱۵ سال تجربه در خدمات مهاجرت، ویزا، اقامت و سفر به ارمنستان. با تیم کاسپین گروه، داستان، مأموریت و ارزش‌های ما بیشتر آشنا شوید." />
