...
🎟️ Տոմսերը QR Code ձևաչափով են և ենթակա չեն վերադարձման։`
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col justify-between font-vazirmatn" dir={lang === 'fa' ? 'rtl' : 'ltr'}>
      ...
      <Helmet>
        <title>
          {lang === 'fa' ? 'رزرو بلیط فستیوال Disco Legends در ایروان | گروه کاسپین' : 
           lang === 'ru' ? 'Бронирование билетов на фестиваль Disco Legends | Caspian Group' : 
           lang === 'hy' ? 'Disco Legends փառատոնի տոմսերի ամրագրում | Caspian Group' : 
           'Disco Legends Festival Ticket Booking | Caspian Group'}
        </title>
        <meta name="description" content={t.title + ' - ' + t.locationText} />
        <link rel="canonical" href="https://caspian.am/retro" />
      </Helmet>
