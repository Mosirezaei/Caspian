...
const content = {
  fa: {
    ...
    directItems: [
      ...
      { icon: 'instagram', label: 'اینستاگرام', value: '@caspian.am', href: 'https://www.instagram.com/caspian.am?igsh=bDBsdTE0ZHJ3bno0', color: 'text-pink-400', bg: 'bg-pink-500/10 border-pink-500/20' },
    ],
    hoursTitle: 'ساعات کاری',
    hours: [
      { day: 'دوشنبه تا شنبه', time: '۹:۰۰ صبح — ۶:۰۰ عصر' },
      { day: 'یکشنبه', time: '۹:۰۰ صبح — ۳:۰۰ بعدازظهر' },
  ...
  en: {
    ...
    directItems: [
      ...
      { icon: 'instagram', label: 'Instagram', value: '@caspian.am', href: 'https://www.instagram.com/caspian.am?igsh=bDBsdTE0ZHJ3bno0', color: 'text-pink-400', bg: 'bg-pink-500/10 border-pink-500/20' },
    ],
...
function ContactContent() {
  ...
  return (
    <div dir={isRtl ? 'rtl' : 'ltr'} className="min-h-screen bg-background font-vazir">
      <Helmet>
        <title>تماس با ما | گروه کاسپین ارمنستان</title>
        <meta name="description" content="راه‌های تماس با کاسپین گروه ارمنستان: تلفن، واتساپ، تلگرام و آدرس دفتر مرکزی در ایروان. همین حالا با کارشناسان ما در ارتباط باشید." />
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 pb-0 space-y-14">
