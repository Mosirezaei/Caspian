...
function Content() {
  ...
  useSEO({
    title: lang === 'fa' ? 'ویزای روسیه برای ایرانیان | اخذ از ایروان - کاسپین گروپ' :
           lang === 'ru' ? 'Виза в Россию для иранцев | Оформление в Ереване' :
           'Russia Visa for Iranians | Apply from Yerevan | Caspian Group',
    description: lang === 'fa' ? 'اخذ ویزای توریستی و تجاری روسیه برای ایرانیان با دعوتنامه رسمی و پشتیبانی کامل از ایروان. پردازش ۵ تا ۱۰ روز کاری.' :
                 lang === 'ru' ? 'Оформление туристической и деловой визы в Россию с официальным приглашением. Обработка 5–10 рабочих дней.' :
                 'Tourist and business Russia visas for Iranians with an official invitation and full support from Yerevan. Processing in 5–10 business days.',
    keywords: lang === 'fa' ? 'ویزای روسیه، ویزای روسیه برای ایرانیان، اخذ ویزای روسیه از ارمنستان، ویزای توریستی روسیه، ویزای تجاری روسیه، دعوتنامه روسیه' :
              lang === 'ru' ? 'виза в Россию, виза в Россию для иранцев, туристическая виза Россия' :
              'Russia visa, Russia visa for Iranians, tourist visa Russia, business visa Russia',
    ogImage: 'https://images.unsplash.com/photo-1513326738677-b964603b136d?w=1200&q=80',
    path: '/visa/russia',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: lang === 'fa' ? 'ویزای روسیه' : 'Russia Visa',
      description: lang === 'fa' ? 'خدمات اخذ ویزای توریستی و تجاری روسیه برای ایرانیان' : 'Tourist and business Russia visa services for Iranians',
