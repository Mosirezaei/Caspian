...
function PageContent() {
  ...
  return (
    <div dir={isRtl ? 'rtl' : 'ltr'} lang={lang} className="min-h-screen bg-background font-vazir">
      <Helmet>
        <title>رزرو بلیط اتوبوس و قطار | گروه کاسپین</title>
        <meta name="description" content="رزرو بلیط اتوبوس و قطار در مسیرهای ایران، ترکیه، گرجستان، ارمنستان، روسیه و آذربایجان با کاسپین گروه. امکان رزرو کوپه دربست و گروهی." />
