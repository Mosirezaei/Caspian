...
function Content() {
  ...
  return (
    ...
    >
      ...
      <Helmet>
        <title>{lang === 'fa' ? 'اخذ اقامت عمان و سرمایه‌گذاری | کاسپین گروه' : 'Oman Residency & Investment Services | Caspian Group'}</title>
        <meta name="description" content={lang === 'fa' ? 'راهنمای اخذ اقامت عمان، اقامت طلایی، خرید ملک و مزایای اقتصادی با پشتیبانی تخصصی کاسپین گروه.' : 'Guide to obtaining Oman residency, golden visa, property purchase, and benefits with Caspian Group.'} />
        <link rel="canonical" href="https://caspian.am/residency/oman" />
      </Helmet>
      ...
      <div className="rounded-2xl overflow-hidden mb-6 aspect-video relative">
        ...
        <div className="absolute bottom-4 start-4 flex items-center gap-2">
          <img src="https://flagcdn.com/w80/om.webp" alt="Oman flag" className="h-6 rounded shadow" />
