...
const INSTAGRAM = 'https://www.instagram.com/caspian.am';
...
const services = {
  fa: [
    ...
    { icon: Hotel, title: 'رزرو هتل', subtitle: 'کاسپین تور از ۲۰۰۷', href: '/travel/hotel', color: 'from-amber-500/20 to-amber-500/5' },
    { icon: HomeIcon, title: 'اجاره آپارتمان', subtitle: 'روزانه و ماهانه در ایروان', href: '/travel/apartment', color: 'from-cyan-500/20 to-cyan-500/5' },
    { icon: Plane, title: 'تور ارمنستان', subtitle: 'تور گروهی و اختصاصی', href: '/travel/tour', color: 'from-emerald-500/20 to-emerald-500/5' },
    ...
    { icon: FileText, title: 'ویزای روسیه', subtitle: 'توریستی و تجاری', href: '/visa/russia', color: 'from-red-500/20 to-red-500/5' },
    ...
    { icon: Landmark, title: 'اقامت ارمنستان', subtitle: 'سریع‌ترین اقامت اروپایی', href: '/residency/armenia', color: 'from-purple-500/20 to-purple-500/5' },
  ...
  en: [
    ...
    { icon: Hotel, title: 'Hotel Booking', subtitle: 'Caspian Tour since 2007', href: '/travel/hotel', color: 'from-amber-500/20 to-amber-500/5' },
    { icon: HomeIcon, title: 'Apartment Rental', subtitle: 'Daily & monthly in Yerevan', href: '/travel/apartment', color: 'from-cyan-500/20 to-cyan-500/5' },
    { icon: Plane, title: 'Armenia Tour', subtitle: 'Group & private tours', href: '/travel/tour', color: 'from-emerald-500/20 to-emerald-500/5' },
    ...
    { icon: FileText, title: 'Russia Visa', subtitle: 'Tourist & business', href: '/visa/russia', color: 'from-red-500/20 to-red-500/5' },
    ...
    { icon: Landmark, title: 'Armenia Residency', subtitle: 'Fastest European residency', href: '/residency/armenia', color: 'from-purple-500/20 to-purple-500/5' },
  ...
  ru: [
    ...
    { icon: Hotel, title: 'Бронирование отелей', subtitle: 'Caspian Tour с 2007 года', href: '/travel/hotel', color: 'from-amber-500/20 to-amber-500/5' },
    { icon: HomeIcon, title: 'Аренда квартир', subtitle: 'Посуточно и помесячно в Ереване', href: '/travel/apartment', color: 'from-cyan-500/20 to-cyan-500/5' },
    { icon: Plane, title: 'Тур по Армении', subtitle: 'Групповые и индивидуальные туры', href: '/travel/tour', color: 'from-emerald-500/20 to-emerald-500/5' },
    ...
    { icon: FileText, title: 'Виза в Россию', subtitle: 'Туристическая и деловая', href: '/visa/russia', color: 'from-red-500/20 to-red-500/5' },
    ...
    { icon: Landmark, title: 'ВНЖ Армении', subtitle: 'Самый быстрый европейский ВНЖ', href: '/residency/armenia', color: 'from-purple-500/20 to-purple-500/5' },
...
function ServicesContent() {
  ...
  return (
    <div dir={isRtl ? 'rtl' : 'ltr'} lang={lang} className="min-h-screen bg-background font-vazir">
      <Helmet>
        <title>همه خدمات | گروه کاسپین ارمنستان</title>
        <meta name="description" content="مشاهده کامل خدمات کاسپین گروه: رزرو هتل، اجاره آپارتمان، تور، ویزا، اقامت تحصیلی، اقامت دائم، ثبت شرکت و بلیط هواپیما و اتوبوس در ایروان." />
