...
- [ ] مرحله ۲ — منوی جدید (GlobalNavbar.jsx) — **در حال انجام، همین نشست**
...
## مرحله ۲ — منوی جدید یکجا (GlobalNavbar.jsx)

- [ ] navLinks کامل بازنویسی بشه برای fa/en/ru با ساختار: صفحه اصلی، خدمات مسافرتی، اقامت، روسیه، وبلاگ (مگامنو گرید)، درباره کاسپین
- [ ] بخش وبلاگ باید مگامنوی گرید چندستونه با آیکون باشه (نه دراپ‌داون ساده مثل بقیه) — هماهنگ با تم تیره+کهربایی+گلس‌پنل
- [ ] کامیت و پوش
